<%-- 
    Document   : MyAddress
    Created on : May 27, 2022, 10:11:40 AM
    Author     : VAN ANH
--%>
                ...
                <div class="row margin-bottom-40">
                    ...
                    <div class="col-md-9 col-sm-7">
                        ...
                        <div class="col-md-9">
                            ...
                            <p>Name : namej</p>
                            <p>Phone number:0123345678</p>
                            <p>Address:abc@gmail.com</p>
                        </div>
                        <div class="col-md-3">

                            <a href="" style="margin-right: 50px">Edit</a>
                            <a href="">Remove</a>
                            <button style="margin-top: 20px" type="submit" class="btn btn-light">
