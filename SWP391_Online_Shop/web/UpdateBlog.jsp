                        ...
                        <form action="updateblog" method="post">
                            ...
                            <div class="modal-body">	
                                <div class="form-group">
                                    <label>ID</label>
                                    <input type="text"  class="form-control" name="id" value="${requestScope.blog.id}" readonly>
                            </div>

                            <div class="form-group">
                                <table>
                                    <label>Author</label>
                                    <input type="text" class="form-control"  name="author" value="${requestScope.blog.author}">
                                </table>
                            </div>
                            <div class="form-group">
                                <table>
                                    <label>Title</label>
                                    <input type="text" class="form-control"  name="title" value="${requestScope.blog.title}" >
                                </table>
                            </div>    
                            <div class="form-group">
                                <label>Content</label>
