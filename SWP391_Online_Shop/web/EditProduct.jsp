                                    ...
                                    <div class="active" id="home"> 
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                ...
                                                <input type="text" value="${pro.productName}" class="form-control" name="Product_name" id="first_name" placeholder="first name" title="enter your first name if any.">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<!--                                                <input type="text" value="${pro.description}" class="form-control" name="Description" id="last_name" placeholder="last name" title="enter your last name if any.">-->
                                                <textarea name="Description"  class="form-control" aria-label="With textarea">${pro.description}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <input type="text" value="${pro.originalPrice}" class="form-control" name="Original_Price" id="phone" placeholder="enter phone" title="enter your phone number if any.">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6">
                                                ...
                                                <input type="text" value="${pro.amount}" class="form-control" name="amount" id="location" placeholder="somewhere" title="enter a location">
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <button class="btn btn-lg" type="productmanager"><i></i> Back</button>
                        </div><!--/tab-content-->
