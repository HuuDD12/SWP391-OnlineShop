                        ...
                        <div class="card-body">
                            <table  id="datatablesSimple">
                                ...
                                <c:forEach items="${list}" var="od">
                                    <tr>  
                                        <td>${od.p.productName}</td>
                                        <td><img src="${od.p.url}" style="height: 100px;width: 100px"></td>
                                        <td><em>$<span>${od.p.originalPrice}</span></em></td>
                                        <td><strong><span>$</span>${od.p.salePrice}</strong></td>
