            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="page-login.html">Register</a></li>
                        <li><a href="LoginHere.jsp">Log In</a></li>
                        <li>
                        <c:if test="${sessionScope.acc.id != null}">
                        <a href="MyAccountPage.jsp">${sessionScope.acc.userName}</a>
                        </c:if>
                    </li>
                    </ul>
                </div>
          ...
          <div class="col-md-12 sale-product">
            ...
            <div class="owl-carousel owl-carousel5">
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/${o.url}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets/pages/img/products/model1.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">${o.product.productName}</a></h3>
        ...
        <div class="row margin-bottom-40 ">
          ...
          <div class="col-md-9 col-sm-8">
            ...
            <div class="owl-carousel owl-carousel3">
                ...
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="assets/pages/img/products/${p.url}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="assets/pages/img/products/k1.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">${p.product.productName}</a></h3>
                  <div class="pi-price">${p.product.salePrice}</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
