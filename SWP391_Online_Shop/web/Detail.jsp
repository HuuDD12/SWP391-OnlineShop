              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="resources/${detail.url}" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="assets/pages/img/products/model7.jpg">
                  </div>
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong><span>$</span>${detail.salePrice}</strong>
                      <em>$<span>${detail.originalPrice}</span></em>
                    </div>
