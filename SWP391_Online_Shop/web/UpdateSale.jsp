                    ...
                    <form action="updatesale" method="post">
                        ...
                        <div class="modal-body">
                            <div class="input-group">
                                <input required  type="text" name="sale" class="form-control" aria-describedby="basic-addon2">
                                <span class="input-group-addon" id="basic-addon2">%</span>
                                <input  type="hidden" name="pid" value="${p.productID}" class="form-control" aria-describedby="basic-addon2">
                            </div>
                        </div>
