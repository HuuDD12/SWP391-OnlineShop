            ...
            <div class="container">
                ...
                <div class="row margin-bottom-40">
                    ...
                    <div class="col-md-9 col-sm-7">
                        ...
                        <div class="col-md-9 col-sm-7">
                            <form action="EditInfo?cid=${info.users.id}" method="post">
                                  <div class="register-page">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputPassword1">First Name</label><p>${info.firstName}</p>
                                        <label for="exampleInputPassword1">Second Name</label><p>${info.secondName}</p>
                                    </div>
