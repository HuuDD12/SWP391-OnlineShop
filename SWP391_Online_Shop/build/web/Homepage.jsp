                                ...
                                <div>
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            <img src="resources/${p.url}" class="img-responsive" alt="Berry Lace Dress">
                                            <div>
                        ...
                        <div class="col-md-9 col-sm-7">
                            ...
                            <c:forEach items="${list}" var="o">
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            <img src=".resources/${o.url}" class="img-producresponsive" alt="Berry Lace Dress">
                                            <div>
                                                <a href="assets/pages/img/products/${o.productImg}" class="btn btn-default fancybox-button">Zoom</a>
                                                <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                            </div>
                                        </div>
                                        <h3><a href="shop-item.html">${o.productName}</a></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <ul class="pagination pull-right">
                                    <ul class="pagination">
                                        <li class="page-item disabled"><a href="HomeControl?index=${tag-1}">Previous</a></li>
                                            <c:forEach  begin="${1}" end="${endP}" var="i">
                                            <li class="page-item"><a href="HomeControl?index=${i}" class="${tag==i?"active":""}">${i}</a></li>
                                            </c:forEach>
                                        <li class="page-item"><a href="HomeControl?index=${tag+1}" class="page-link">Next</a></li>
                                    </ul>
                                </ul>
                            </div>
                        </div>
