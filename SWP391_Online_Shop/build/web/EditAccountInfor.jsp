<%-- 
    ...
    Created on : May 27, 2022, 9:52:53 AM
    Author     : VAN ANH
--%>
                ...
                <div class="header-navigation">
                    <ul>
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="Homepage.jsp">Home Default</a></li>
                ...
                <div class="row margin-bottom-40">
                    ...
                    <div class="sidebar col-md-3 col-sm-3">
                        <ul class="list-group margin-bottom-25 sidebar-menu">
                            ...
                            <li class="active list-group-item clearfix"><a href="javascript:;"><i class="fa fa-angle-right"></i> My account</a></li>
                        ...
                        <div class="register-page">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" id="exampleInputPassword1" placeholder="Middle Name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="phoneNumber" class="form-control" id="exampleInputPhone" aria-describedby="emailHelp" placeholder="Enter phone number">
