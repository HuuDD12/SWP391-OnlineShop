<%-- 
    Document   : Detail
    Created on : May 27, 2022, 10:48:21 PM
    Author     : dell
--%>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="product-main-image">
                                        <img src="assets/pages/img/products/${detail.productImg}" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="assets/pages/img/products/model7.jpg">
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="price-availability-block clearfix">
                                        <div class="price">
                                            <strong><span>$</span>${detail.product.salePrice}</strong>
                                            <em>$<span>${detail.product.originalPrice}</span></em>
                                        </div>
                                ...
                                <div class="product-page-content">
                                    <ul id="myTab" class="nav nav-tabs">
                                        ...
                                        <li class=""><a href="" data-toggle="tab">Reviews</a></li>
                                    </ul>
