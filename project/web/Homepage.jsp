...
<!--                            <li><a href="MyAccountPage.jsp">My Account</a></li>-->
                            ...
                            <li><a href="shop-checkout.html">Checkout</a></li>
                                ...
                                <li><a href="MyAccountPage.jsp">${sessionScope.acc.userName}</a></li>
                                
                                <li><a href="logout">Logout</a></li>
                            </c:if>       

                            <li><a href="ManagementAccount.jsp">Users List</a></li>
                                    ...
                                    <div class="header-navigation-content">
                                        <div class="row">
                                            <div class="col-md-4 header-navigation-col">
                                                <c:forEach items="${listS}" var="o" begin="0" end="3">
                                                    <h4>${o.category.cname}</h4>

                                                    <ul>
                                                        <li><a href="shop-product-list.html">${o.subName}</a></li>

                                                    </ul>
                                                </c:forEach>
                                            </div>
                                            <div class="col-md-4 header-navigation-col">
                                                <c:forEach items="${listS}" var="o" begin="4" end="7">
                                                    <h4>${o.category.cname}</h4>
                                            ...
                                            <div class="col-md-4 header-navigation-col">
                                                <c:forEach items="${listS}" var="o" begin="8" end="9">
                                                    <h4>${o.category.cname}</h4>
                            ...
                            <div class="search-box">
                                <form action="search" method="post">
                                    <div class="input-group">
                                        <input value="${txt}" type="text" name="txt" placeholder="Search" class="form-control">
                                    ...
                                    <c:forEach items="${listS}" var="o">
                                        <form action = "home" method = "post">
                                            <li class="list-group-item dropdown clearfix">
                                                ...
                                                <a href=""><i class="fa fa-angle-right"></i>${o.category.cname}</a>
                                                <ul class="dropdown-menu">
                                                    <li class="list-group-item dropdown clearfix">

                                                        <a href=""><i class="fa fa-angle-right"></i>${o.subName}</a>
                                ...
                                <ul class="dropdown-menu">
                                    <c:forEach items="${listB}" var="o">
                                        <li class="list-group-item dropdown clearfix">
                                            ...
                                            <a href=""><i class="fa fa-angle-right"></i>${o.brandName}</a>
                                            <ul class="dropdown-menu">
                        ...
                        <h2>Three items</h2>
                            ...
                            <div class="owl-carousel owl-carousel3">
                                ...
                                <div>
                                    ...
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            <img src="assets/pages/img/products/${o.productImg}" class="img-responsive" alt="Berry Lace Dress">
                                            <div>
                                                <a href="assets/pages/img/products/${o.productImg}" class="btn btn-default fancybox-button">Zoom</a>
                                                <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                                            </div>
                                        </div>
                                        <h3><a href="detail?cid=${o.product.id}">${o.product.name}</a></h3>
                                        <div class="pi-price">${o.product.salePrice}</div>
                                        <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                                        <div class="sticker sticker-new"></div>
