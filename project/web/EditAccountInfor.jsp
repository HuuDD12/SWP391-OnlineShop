                            ...
                            <div class="register-page">
                                ...
                                <form action="SaveInfo" method="post">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputPassword1">Account name</label><p>${info.users.userName}</p>
                                        
                                        <input value="${info.users.id}" type="hidden" name="id" class="form-control" id="exampleInputPassword1" placeholder="First Name">

                                        <label for="exampleInputPassword1">First Name</label>
                                        <input value="${info.firstName}" type="name" name="firstName" class="form-control" id="exampleInputPassword1" placeholder="First Name">
                                        <label for="exampleInputPassword1">Second Name</label>
                                        <input value="${info.secondName}" type="name" name="secondName" class="form-control" id="exampleInputPassword1" placeholder="Last Name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="${info.phone}" type="phoneNumber" name="phoneNumber" class="form-control" id="exampleInputPhone" aria-describedby="emailHelp" placeholder="Enter phone number">

                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPhone">Address</label>
                                        <input value="${info.address}" type="address" name="address" class="form-control" id="exampleInputPhone" aria-describedby="emailHelp" placeholder="Enter phone number">
