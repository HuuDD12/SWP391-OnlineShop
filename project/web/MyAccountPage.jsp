<%-- 
    Document   : MyAccountPge
    Created on : May 29, 2022, 10:19:34 AM
    Author     : dell
--%>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="content-page">
              <h3>My Account</h3>
              <ul>
                <li><a href="ManagerAccountInfor?cid=${acc.id}">Edit your account information</a></li>
                <li><a href="ChangePassword.jsp">Change your password</a></li>
                <li><a href="ManagerAddress?cid=${acc.id}">Modify your address book entries</a></li>
              ...
              <h3>My Orders</h3>
              <ul>
                <li><a href="ViewHistoryOrders">View your order history</a></li>
