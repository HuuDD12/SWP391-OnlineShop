<%-- 
    Document   : MyAddress
    Created on : Jun 1, 2022, 11:02:55 PM
    Author     : dell
--%>
                                ...
                                <div class="table-wrapper-responsive">
                                    <table summary="Shopping cart">
                                        <tr>
                                            ...
                                            <th class="goods-page-description">Address</th>
                                            <th class="goods-page-stock">Phone Number</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="del-goods-col">
                                                <a class="" href="javascript:;">Remove</a>
                                            </td>
                                            <td><button type="submit" class="btn btn-primary">Default</button></td>
                                        </tr>
