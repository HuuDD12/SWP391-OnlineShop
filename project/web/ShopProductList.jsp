                    ...
                    <div class="col-md-9 col-sm-7">
                        ...
                        <table>
                            ...
                            <c:forEach items="${listP}" var="o">
                                <tr>
                                    <th>${o.product.id}</th>
                                    <th><img src="assets/pages/img/products/${o.productImg}" class="img-responsive" style="width: 200px;height: 200px" alt="Berry Lace Dress"></th>
                                    <th>${o.product.name}</th>
                                    <th>${o.product.description}</th>
                                    <th>${o.product.brand.brandName}</th>
                                    
                                    <th>${o.product.originalPrice}</th>
                                    <th>${o.product.salePrice}</th>
                                    <th><a href="">Edit</a></th>
                        ...
                        <!--                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                        <div class="product-item">
                                                            ...
                                                            <h3><a href="shop-item.html">${o.product.name}</a></h3>
