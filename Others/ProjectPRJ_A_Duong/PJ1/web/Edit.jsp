                ...
                <div class="modal-content">
                    <form action="update" method="post">
                        <div class="modal-header">						
                            <h4 style="color:green"  class="modal-title">Update Product</h4>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_cat" class="form-select" aria-label="Default select example">
                                    <c:forEach items="${listC}" var="o">
                                        <option ${detail.id_cat==o.id_cat?"selected":""}   value="${o.id_cat}">${o.name_cat}</option>
                                    </c:forEach>                                  
                                </select>				
                           </div>
                            </div>
                        <div class="modal-footer">
                            <a href="manager-product"><button type="button" class="btn btn-primary">Back</button</a>
